...
a persistence unit "upsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ups/pom.xml":
...
artifact ("ups.war") is already built. You can build
